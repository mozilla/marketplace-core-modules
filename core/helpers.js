define('core/helpers',
       ['core/capabilities', 'core/format', 'core/l10n', 'core/nunjucks',
        'core/settings', 'core/urls', 'core/user', 'core/utils', 'underscore'],
       function(capabilities, format, l10n, nunjucks,
                settings, urls, user, utils, _) {
    ...
    var helpers = {
        api: urls.api.url,
        apiHost: urls.api.host,
        apiParams: urls.api.params,
        anonApi: urls.api.unsigned.url,
        anonApiParams: urls.api.unsigned.params,
        url: urls.reverse,
        media: urls.media,
